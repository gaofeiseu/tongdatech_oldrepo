...
<html>
	...
	<body onload="initialize('map_canvas',config.maxZoon,'${session.userInfo.lat}','${session.userInfo.lng}');"  class="easyui-layout">
		...
		<div data-options="region:'east',split:true,collapsed:true" title="签到查询" style="width: 183px;">
			...
			<fieldset>
				<legend>
              		<input type="checkbox" name="ljhx_radiobutton" value="4" /> 机构查询：
              	</legend>
              	<div>
              		是否包含下级机构：<input type="checkbox" name="if_include_childbrch" id="if_include_childbrch" value="1" /> 
              	</div>
              	<div>
              		<input type="text" name="ljhx_brchno_query" id="ljhx_brchno_query" style="width: 150px" />
              	</div>
			</fieldset>
			
			<fieldset>
				<legend>
              		<input type="checkbox" name="ljhx_radiobutton" value="5" /> 定位类型：
              	</legend>
              	<div><input type="text" id="ljhx_location_type" name="ljhx_location_type" class="easyui-combobox" style="width: 150px" data-options="valueField:'value',textField:'text',data:${application.ParamJson.CHECK_IN_TYPE}"/></div>
			</fieldset>
			
			<fieldset>
				<legend>
              		<input type="checkbox" name="ljhx_radiobutton" value="6" /> 走访形式：
              	</legend>
              	<div><input type="text" id="ljhx_zoufang_type" name="ljhx_zoufang_type" class="easyui-combobox" style="width: 150px" data-options="valueField:'value',textField:'text',data:${application.ParamJson.MOBILE_VISIT_CLASS}"/></div>
			</fieldset>
            ...
            <div id="show_msg_s" align="center"><font color='red'><div id="echo_query_msg"></div></font></div>
            <div id="detail_table" style="display:none">
            	<div id="time_show_str"></div>
            	<table id="hidden_table1" border="1" style="width: 170px;">
				</table>
            </div>
            <div id="hidden_detail_info" style="display:none">
            	<a href="#" onclick="$('#more_detail_dlg').dialog('open');">统计详情</a>
            </div>
		</div>
			<!-- 复制弹出层-->
		<div id="copy_dialog" title="复制" class="easyui-dialog panel-body panel-body-noborder window-body" data-options="iconCls:'icon-add',closed:true,modal:true" title="" style="overflow: auto; width: 400px; height: 300px;">
		<form action="" method="post" enctype="multipart/form-data"  id="copyform">
	
		 <table id='copy_table1' style='width:100%;'>
		 	<tr ></tr>
		 </table>
		...
		<table id='copy_table2' style='width:100%;'>
			...
			<!-- 修改弹出层-->
		<div id="modify_dialog" title="信息修改" class="easyui-dialog panel-body panel-body-noborder window-body" data-options="iconCls:'icon-edit',closed:true,modal:true" title="" style="overflow: auto; width: 400px; height: 300px;">
			<form action="" method="post" enctype="multipart/form-data"  id="modifyform">
 		<table id='modify_table1' style='width:100%;'>
		 	<tr></tr>
		 </table>

		<table id='modify_table2' style='width:100%;'>
		 	<tr></tr>
		...
		<!-- 详细信息-->
		<div id="show_dialog" title="详细信息" class="easyui-dialog panel-body panel-body-noborder window-body" data-options="iconCls:'icon-edit',closed:true,modal:true" title="" style="overflow: auto; width: 400px; height: 300px;">
	 	...
	 	<div id="more_detail_dlg" class="easyui-dialog" title="统计详情" closed="true" data-options="iconCls:'icon-add',closed:true" style="width:550px;height:450px;padding:10px">
	 		<div id="time_show_str2"></div>
        	<table id="hidden_table2" border="1" style="width:100%;">
			</table>
    	</div>

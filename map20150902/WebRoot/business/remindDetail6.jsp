...
<body>
	<table id="dg" class="easyui-datagrid"
		data-options="title:'凭证式国债到期客户',
     	fit:true,rownumbers:true,pagination:true,pageSize:50,singleSelect:true" url="/remind_getDetail.action?query_type=6&user_root_brch=${session.userInfo.brch_no}">
        <thead>
            <tr>

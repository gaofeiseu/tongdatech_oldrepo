...
<html>
	<head>
		...
		<script type="text/javascript" src="/map/mapjs/map_datainput.js" charset="GBK"></script>
			...
			<form id="queryfm" action="map_datainput_uploadTemplat.action" style="margin: 40px auto;width:600px" method="post" enctype="multipart/form-data">
				<div>
					...
					<div class="form_item col2">
						<label>标注主类型:</label>
						<input type="text" id="mainclass_sn" name="mainclass_sn" class="easyui-combobox" style="width: 150px" data-options="valueField:'value',textField:'text',panelHeight:'auto',data:${application.ParamJson.MARKER_TYPE},onChange:function(newvalue,oldvalue){loadChildComboForComboSelectChange(newvalue);}"/>
		    		</div>
		  
					<div class="form_item col2">
			    		<label>标注子类型:</label>
						<input type="text" id="childclass_sn" name="childclass_sn" class="easyui-combobox" style="width: 150px" data-options="valueField:'value',textField:'text',panelHeight:'auto'"/>
					</div>

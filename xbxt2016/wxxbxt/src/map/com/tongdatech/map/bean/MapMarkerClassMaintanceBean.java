 ...
 *
 */
public class MapMarkerClassMaintanceBean {
	@PageParam
	...
	@PageParam
	private String childclass_add_brch_type;
	...
	@PageParam
	private String childclass_edit_brch_type;
	...
	private String checkBrch;
	
	
	public String getCheckBrch() {
		return checkBrch;
	}
	public void setCheckBrch(String checkBrch) {
		this.checkBrch = checkBrch;
	}
	...
	public String getChildclass_add_brch_type() {
		return childclass_add_brch_type;
	}
	public void setChildclass_add_brch_type(String childclass_add_brch_type) {
		this.childclass_add_brch_type = childclass_add_brch_type;
	}
	public String getChildclass_edit_brch_type() {
		return childclass_edit_brch_type;
	}
	public void setChildclass_edit_brch_type(String childclass_edit_brch_type) {
		this.childclass_edit_brch_type = childclass_edit_brch_type;
	}
	@Override
	public String toString() {
		return "MapMarkerClassMaintanceBean [parentclass_sn=" + parentclass_sn
				+ ", childclass_sn=" + childclass_sn + ", childclass_name="
				+ childclass_name + ", childclass_brchno=" + childclass_brchno
				+ ", childclass_brchstr=" + childclass_brchstr
				+ ", childclass_status=" + childclass_status
				+ ", childclass_status_str=" + childclass_status_str
				+ ", childclass_add_for_parentclassid="
				+ childclass_add_for_parentclassid
				+ ", childclass_add_classname=" + childclass_add_classname
				+ ", childclass_add_brch=" + childclass_add_brch
				+ ", childclass_add_status=" + childclass_add_status
				+ ", childclass_add_brch_type=" + childclass_add_brch_type
				+ ", sn_for_deletechildclass=" + sn_for_deletechildclass
				+ ", childclasssn_edit=" + childclasssn_edit
				+ ", childclass_edit_classname=" + childclass_edit_classname
				+ ", childclass_edit_brch=" + childclass_edit_brch
				+ ", childclass_edit_status=" + childclass_edit_status
				+ ", childclass_edit_brch_type=" + childclass_edit_brch_type
				+ ", classproperty_id=" + classproperty_id
				+ ", classproperty_parentclass_id="
				+ classproperty_parentclass_id
				+ ", classproperty_parentclass_tn="
				+ classproperty_parentclass_tn
				+ ", classproperty_parentclass_cn="
				+ classproperty_parentclass_cn + ", classproperty_name="
				+ classproperty_name + ", classproperty_type="
				+ classproperty_type + ", classproperty_type_str="
				+ classproperty_type_str + ", classproperty_ifnull="
				+ classproperty_ifnull + ", classproperty_ifnull_str="
				+ classproperty_ifnull_str + ", classproperty_size="
				+ classproperty_size + ", classproperty_status="
				+ classproperty_status + ", classproperty_status_str="
				+ classproperty_status_str + ", classproperty_add_sn="
				+ classproperty_add_sn + ", classproperty_add_name="
				+ classproperty_add_name + ", classproperty_add_type="
				+ classproperty_add_type + ", classproperty_add_ifnull="
				+ classproperty_add_ifnull + ", classproperty_add_size="
				+ classproperty_add_size + ", classproperty_add_status="
				+ classproperty_add_status + ", sn_for_deleteclassproperty="
				+ sn_for_deleteclassproperty + ", sn_for_editclassproperty="
				+ sn_for_editclassproperty + ", name_for_editclassproperty="
				+ name_for_editclassproperty
				+ ", status_for_editclassproperty="
				+ status_for_editclassproperty + ", t_user_type=" + t_user_type
				+ ", obj_name=" + obj_name + ", checkBrch=" + checkBrch + "]";
	}

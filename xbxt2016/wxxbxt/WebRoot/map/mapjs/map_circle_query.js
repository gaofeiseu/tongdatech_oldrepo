...
GeoQuery.prototype.initializeCircle = function(radius, point, map) {
 ...
 // 设置中心点的样式
    this._centerHandle = new google.maps.Marker({  
        ...
        map: map,  
        draggable:true,  
        icon:"/mapfiles/markers/transparent.png"//"/mapfiles/markers/spotmkrs_2b70b09.png"  
    });   
...
GeoQuery.prototype.initializeCircleRead = function(radius, point, map) {
 ...
 // 设置中心点的样式
    this._centerHandle = new google.maps.Marker({  
        ...
        map: map,  
        draggable:true,  
        icon:"/mapfiles/markers/transparent.png"  
    });   
				...
				if(msg.if_success){
					...
					if(pathpoint.marker_type=="2")//线
					{
							...
							if(checkDest(line_lat_Array,line_lng_Array,geoQuery))
							{
								...
								var stIconurl="/mapfiles/markers/transparent.png";
								...
								var edIconurl="/mapfiles/markers/transparent.png";

...
<body>
	<table id="dg" class="easyui-datagrid"
		data-options="title:'理财到期客户',
     	fit:true,rownumbers:true,pagination:true,pageSize:50,singleSelect:true" url="/remind_getDetail.action?query_type=4&user_root_brch=${session.userInfo.brch_no}">
        <thead>
            <tr>
                <th field="OPEN_OFFICE_CODE" width="100">网点机构号</th>
                <th field="CONTRACTNO" width="100">合同号</th>
